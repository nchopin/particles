...
plt.hist(npf_path.squeeze(), 500, density=True)
plt.plot(xplot, dens, '--')
plt.xlim(-2,2)
plt.subplot(322)
plt.hist(npf_path.squeeze(), 500, weights=npf.wgts.W, density=True)
plt.plot(xplot, dens, '--')
plt.xlim(-2,2)
# ensemble Kalman
...
plt.hist(ek_path.squeeze(), 500, density=True)
plt.plot(xplot, dens, '--')
plt.xlim(-2,2)
...
# plt.tight_layout()
plt.hist(particle_path.squeeze(), 500, density=True)
plt.plot(xplot, dens, '--')
plt.xlim(-2,2)
plt.subplot(326)
plt.hist(particle_path.squeeze(), 500, weights=pf.wgts.W, density=True)
plt.plot(xplot, dens, '--')
